...
frange = linspace(1e6,5e6,50);% frequency range of interest
...
elas_mod_range = 2%:0.01:0.9%:0.1:1;% Elastic compression modulus (Marmottant model), N/m Chi
kaps_range =  1e-8%[1:1:25]*1e-9;% Interfacial dilational viscosity
sig_mar_range = 0.0%[0:0.001:0.02];% initial Surface tension water/lipid/PFC interface (coated bubble), N/m
nratio = 1% adjustment of mbs concentration
...
if plott == 1;
    ...
    legend('simulation','simulation-experimentf','experiment');
